import { Clock, Database, Zap, Info, ChevronDown, ChevronUp, Activity } from 'lucide-react';
...
const Sidebar = ({ currentAlgorithm, isRunning, visitedCount, pathLength }: SidebarProps) => {
  ...
  return (
    <div className="w-80 bg-card/50 backdrop-blur-md border-r border-border/50 h-full overflow-y-auto animate-slide-in-left">
      <div className="p-6">
        {/* Logo & Title */}
        ...
        {/* Live Statistics - Prominent placement */}
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="btn-glass rounded-lg p-4 text-center">
              <p className="text-2xl font-bold font-mono text-primary">{visitedCount}</p>
              <p className="text-xs text-muted-foreground mt-1">Nodes Explored</p>
            </div>
            <div className="btn-glass rounded-lg p-4 text-center">
        ...
        <div className="mb-6">
          ...
          <div className="btn-glass rounded-lg p-4">
        ...
        <div className="mb-6">
          <button
            ...
            className="flex items-center justify-between w-full text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-3 hover:text-foreground transition-colors"
          >
          ...
          >
            ...
            {/* Key Points */}
            <div className="mt-4 btn-glass rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <div className="w-5 h-5 rounded bg-node-path glow-accent" />
        ...
        {/* Status Indicator */}
        {isRunning && (
          <div className="mt-6 btn-glass-primary rounded-lg p-4">
            <div className="flex items-center gap-3">
              <div className="w-3 h-3 rounded-full bg-primary animate-pulse" />
              <span className="text-sm font-medium text-primary">Executing Search...</span>
            </div>
          </div>
        )}
      </div>
